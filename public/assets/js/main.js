...
/***/ function(module, exports, __webpack_require__) {
	...
	var _anchor = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SliderBlock = function () {
	  ...
	  var prefix = 'js-',
	      blockName = 'slider',
	      block = (0, _jquery2.default)('.' + prefix + blockName),
	  ...
	  return {
	    ...
	    load: function load() {
	      ...
	      var slideActiveClassName = block.data('active');
	      var isLoop = block.data('loop');
	      var animation = block.data('animation');
	      var animationPrev = block.data('animation-direction-prev');
	      var animationNext = block.data('animation-direction-next');
	
	      var $slides = (0, _jquery2.default)('.js-slider-slide');
	      var slidesIndexes = [];
	      var $prevSlideHandler = (0, _jquery2.default)('.js-slider-arrow-prev');
	      var $nextSlideHandler = (0, _jquery2.default)('.js-slider-arrow-next');
	      ...
	      $slides.each(function (i, element) {
	        var index = (0, _jquery2.default)(element).index();
	        slidesIndexes.push(index);
	      });
	
	      var $activeSlide = $slider.find('.' + slideActiveClassName);
	      var currentIndex = $activeSlide.index();
	      var firstIndex = slidesIndexes[0];
	      var lastIndex = slidesIndexes[slidesIndexes.length - 1];
	
	      $slider.on('slider:check', function (e) {
	      ...
	      $prevSlideHandler.on('click', function (e) {
	        e.preventDefault();
	      ...
	      $nextSlideHandler.on('click', function (e) {
	        e.preventDefault();
	      ...
	      $slider.on('slider:prev', function (e, $activeSlide) {
	      ...
	      $slider.on('slider:next', function (e, $activeSlide) {
	      ...
	      $slider.on('slider:set', function (e, $activeSlide, $slide, direction, backDirection) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HamburgerBlock = function () {
	  ...
	  return {
	    ...
	    load: function load() {
	      ...
	      var $hamburgerHandler = block.find('.js-hamburger-handler');
	      var $logo = (0, _jquery2.default)('.logo');
	
	      var $hamburgerTarget = (0, _jquery2.default)($hamburgerHandler.data('target'));
	      var targetActiveClassName = $hamburgerHandler.data('active');
	
	      $hamburgerHandler.on('hamburger:check', function (e) {
	      ...
	      $hamburgerHandler.on('click', function (e) {
	        e.preventDefault();
	      ...
	      $hamburgerHandler.on('hamburger:hide', function (e, $target, activeClass) {
	        $target.removeClass(activeClass);
	        $hamburgerHandler.trigger('hamburger:check');
	      });
	
	      $hamburgerHandler.on('hamburger:show', function (e, $target, activeClass) {
	...
	exports.default = HamburgerBlock;
	...
	var AnchorBlock = function () {
	  ...
	  return {
	    ...
	    load: function load() {
	      ...
	      var $handler = (0, _jquery2.default)('.js-anchor-handler');
	      var $target = (0, _jquery2.default)('.js-anchor');
	
	      $handler.on('click', function (e) {
	        e.preventDefault();
	
	        _jquery2.default.scrollTo($target, 200, {
	          easing: 'swing'
	        });
	      });
	    },
